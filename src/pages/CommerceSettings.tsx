...
const ComercioSettings = () => {
  ...
  const { loading: payLoading, isEnabled, getByType, toggle, saveMPData } = usePaymentMethods(venue?.id);
  ...
  try {
    ...
    const location_embed = normalizedMapsUrl ? toGoogleMapsEmbed(normalizedMapsUrl) : null;
  ...
  return (
        ...
        <div className="bg-card border border-border rounded-lg p-6 mb-8">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
                Este enlace se mostrará para que los clientes puedan encontrar el
                local (especialmente útil para retiro)
              </p>
            </div>
    ...
    <div className="flex items-center gap-3 mb-4">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">Elegí cómo querés cobrar</p>
      </div>
    </div>
    ...
    <div className="flex items-center justify-between py-3 border-b border-border">
      <div>
        ...
        <p className="text-xs text-muted-foreground">El cliente paga al retirar / recibir</p>
      </div>
      <Switch
