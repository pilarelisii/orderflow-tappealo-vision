...
import { ArrowLeft, Printer, RefreshCw, CheckCircle, XCircle, Download, TestTube } from 'lucide-react';
              ...
              <Alert>
                ...
                <AlertDescription className="space-y-2">
                  ...
                  <ol className="list-decimal list-inside text-sm space-y-1">
                    <li>Descarga QZ Tray desde <a href="https://qz.io/download/" target="_blank" rel="noopener noreferrer" className="text-primary underline">qz.io/download</a></li>
