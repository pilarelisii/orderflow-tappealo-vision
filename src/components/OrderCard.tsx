...
import { ChevronRight, MapPin, MessageSquare, Clock } from "lucide-react";
...
export function OrderCard({ order, onMoveNext }: OrderCardProps) {
  ...
  return (
    <Card className="p-4 mb-3 animate-fade-in hover:shadow-md transition-shadow">
      ...
      {order.comentarios_generales && (
        <div className="flex items-start gap-2 text-sm bg-accent/50 p-2.5 rounded-lg mb-3">
